<?php /* Smarty version 2.6.20, created on 2011-06-07 20:00:45
         compiled from /homez.387/lilibio/www2/site2.1/modules/blockcategories/category-tree-branch.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/homez.387/lilibio/www2/site2.1/modules/blockcategories/category-tree-branch.tpl', 2, false),array('modifier', 'count', '/homez.387/lilibio/www2/site2.1/modules/blockcategories/category-tree-branch.tpl', 3, false),)), $this); ?>
...
" <?php if ($this->_tpl_vars['node']['id'] == $this->_tpl_vars['currentCategoryId']): ?>class="selected"<?php endif; ?> "><?php echo ((is_array($_tmp=$this->_tpl_vars['node']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'UTF-8') : smarty_modifier_escape($_tmp, 'html', 'UTF-8')); ?>
</a>
