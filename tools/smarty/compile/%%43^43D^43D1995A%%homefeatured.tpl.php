<?php /* Smarty version 2.6.20, created on 2011-06-07 20:01:10
         compiled from /homez.387/lilibio/www2/site2.1/modules/homefeatured/homefeatured.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/homez.387/lilibio/www2/site2.1/modules/homefeatured/homefeatured.tpl', 3, false),array('function', 'convertPrice', '/homez.387/lilibio/www2/site2.1/modules/homefeatured/homefeatured.tpl', 18, false),array('modifier', 'count', '/homez.387/lilibio/www2/site2.1/modules/homefeatured/homefeatured.tpl', 8, false),array('modifier', 'ceil', '/homez.387/lilibio/www2/site2.1/modules/homefeatured/homefeatured.tpl', 9, false),array('modifier', 'truncate', '/homez.387/lilibio/www2/site2.1/modules/homefeatured/homefeatured.tpl', 14, false),array('modifier', 'escape', '/homez.387/lilibio/www2/site2.1/modules/homefeatured/homefeatured.tpl', 14, false),array('modifier', 'strip_tags', '/homez.387/lilibio/www2/site2.1/modules/homefeatured/homefeatured.tpl', 15, false),)), $this); ?>
...
" title="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['product']['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 50, '...') : smarty_modifier_truncate($_tmp, 50, '...')))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['product']['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 45, '...') : smarty_modifier_truncate($_tmp, 45, '...')))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
</a></h5>
