<?php /* Smarty version 2.6.20, created on 2011-06-07 20:00:46
         compiled from /homez.387/lilibio/www2/site2.1/themes/prestashop/header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/homez.387/lilibio/www2/site2.1/themes/prestashop/header.tpl', 5, false),array('function', 'l', '/homez.387/lilibio/www2/site2.1/themes/prestashop/header.tpl', 43, false),)), $this); ?>
...
?v=<?php  $css_path = getcwd().$this->get_template_vars('css_uri'); echo filemtime($css_path); ?>" rel="stylesheet" type="text/css" media="<?php echo $this->_tpl_vars['media']; ?>
" />
...
logo2.jpg" alt="<?php echo ((is_array($_tmp=$this->_tpl_vars['shop_name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
" /></a></div>
				<div id="header_right">
