<?php /* Smarty version 2.6.20, created on 2011-05-07 09:42:48
         compiled from /homez.387/lilibio/www2/site2.0/modules/productscategory/productscategory.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/homez.387/lilibio/www2/site2.0/modules/productscategory/productscategory.tpl', 5, false),array('function', 'math', '/homez.387/lilibio/www2/site2.0/modules/productscategory/productscategory.tpl', 11, false),array('modifier', 'count', '/homez.387/lilibio/www2/site2.0/modules/productscategory/productscategory.tpl', 11, false),array('modifier', 'htmlspecialchars', '/homez.387/lilibio/www2/site2.0/modules/productscategory/productscategory.tpl', 14, false),array('modifier', 'truncate', '/homez.387/lilibio/www2/site2.0/modules/productscategory/productscategory.tpl', 18, false),array('modifier', 'escape', '/homez.387/lilibio/www2/site2.0/modules/productscategory/productscategory.tpl', 18, false),)), $this); ?>
...
" title="<?php echo ((is_array($_tmp=$this->_tpl_vars['categoryProduct']['name'])) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
">
			<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['categoryProduct']['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 30, '...') : smarty_modifier_truncate($_tmp, 30, '...')))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
