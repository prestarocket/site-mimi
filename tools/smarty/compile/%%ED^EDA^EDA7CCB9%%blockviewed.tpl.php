<?php /* Smarty version 2.6.20, created on 2011-06-07 20:00:46
         compiled from /homez.387/lilibio/www2/site2.1/modules/blockviewed/blockviewed.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/homez.387/lilibio/www2/site2.1/modules/blockviewed/blockviewed.tpl', 3, false),array('function', 'm', '/homez.387/lilibio/www2/site2.1/modules/blockviewed/blockviewed.tpl', 10, false),array('modifier', 'escape', '/homez.387/lilibio/www2/site2.1/modules/blockviewed/blockviewed.tpl', 8, false),array('modifier', 'truncate', '/homez.387/lilibio/www2/site2.1/modules/blockviewed/blockviewed.tpl', 9, false),array('modifier', 'strip_tags', '/homez.387/lilibio/www2/site2.1/modules/blockviewed/blockviewed.tpl', 10, false),)), $this); ?>
...
" title="<?php echo smartyTranslate(array('s' => 'More about','mod' => 'blockviewed'), $this);?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['viewedProduct']->name)) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'UTF-8') : smarty_modifier_escape($_tmp, 'html', 'UTF-8')); ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['viewedProduct']->name)) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'UTF-8') : smarty_modifier_escape($_tmp, 'html', 'UTF-8')))) ? $this->_run_mod_handler('truncate', true, $_tmp, 70, '...') : smarty_modifier_truncate($_tmp, 70, '...')); ?>
</a></h5>
					<p><?php echo smartyMaxWords(array('s' => ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['viewedProduct']->description_short)) ? $this->_run_mod_handler('strip_tags', true, $_tmp, 'UTF-8') : smarty_modifier_strip_tags($_tmp, 'UTF-8')))) ? $this->_run_mod_handler('truncate', true, $_tmp, 60) : smarty_modifier_truncate($_tmp, 60)),'n' => 12), $this);?>
<a href="<?php echo $this->_tpl_vars['link']->getProductLink($this->_tpl_vars['viewedProduct']->id,$this->_tpl_vars['viewedProduct']->link_rewrite,$this->_tpl_vars['viewedProduct']->category_rewrite); ?>
" title="<?php echo smartyTranslate(array('s' => 'More about','mod' => 'blockviewed'), $this);?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['viewedProduct']->name)) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'UTF-8') : smarty_modifier_escape($_tmp, 'html', 'UTF-8')); ?>
