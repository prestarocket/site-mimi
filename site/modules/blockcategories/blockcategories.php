...
class BlockCategories extends Module
{
  ...
  function hookLeftColumn($params)
  {
    ...
    $var_backup = $memcache->get('categories_subblock'); 
    if ( $var_backup == FALSE)
      {
	...
	$memcache->set ('categories_subblock', 
			Array('blockCategTree' => $blockCategTree,
			      'isDhtml'        => $isDhtml),
			MEMCACHE_COMPRESSED, 3600 );  /* Keep it a day */

      }else{
      $blockCategTree = $var_backup['blockCategTree'];
      $isDhtml = $var_backup['isDhtml'];
    }
